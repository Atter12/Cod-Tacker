...
const statusClasses: Record<string, string> = {
  ...
  unpaid: "bg-success/10 text-success",
  ...
  cash_expected: "bg-warning/10 text-warning",
  ...
  ready_to_ship: "bg-brand-primary/10 text-brand-primary",
  ...
  sending: "bg-brand-primary/10 text-brand-primary",
  delivery_failed: "bg-danger/10 text-danger",
  return_in_transit: "bg-danger-soft text-danger",
