  ...
  return (
    ...
    >
      ...
      <p className="mt-5 max-w-[560px] text-[15px] leading-relaxed text-[#94A3B8]">
        CODTracked centraliza pedidos, confirmaciones, entregas, RTO, devoluciones e integraciones
        para todas tus tiendas.
      </p>
      ...
      <div className="mt-8 grid min-h-0 flex-1 gap-4 lg:grid-cols-[1fr_auto]">
        <div className="rounded-2xl border border-[rgba(76,139,170,0.18)] bg-[#071426]/90 p-5">
          <div className="flex flex-wrap items-baseline justify-between gap-2">
            ...
            <p className="text-[12px] font-medium text-[#22D3EE]">Holistic Ecommerce</p>
          </div>
        ...
        <div className="hidden w-[148px] shrink-0 flex-col gap-2.5 xl:flex">
          {stores.map((store) => (
            <div
              ...
              className={
                store.selected
                  ? "flex items-center gap-2.5 rounded-xl border border-[rgba(25,199,181,0.55)] bg-[#0D1B30] px-3 py-2.5"
